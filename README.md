...
- **Evidence Vault has no automated screenshot capture** - this stack has
  ...
  view, not a pixel-level diff. "Annotate" (drawing/markup on an image) is
  not implemented - captions only.
